...
export interface ContentPack extends Audit{id:ID;name:string;description?:string;version:string;schemaVersion:number;rulesEditions:Edition[];visibility:"public"|"private";licenseType:LicenseType;exportRestricted:boolean;includeFullText:boolean;dependencies:ID[];optionalDependencies:ID[];sourceIds:ID[];entryIds:ID[];checksum?:string}
