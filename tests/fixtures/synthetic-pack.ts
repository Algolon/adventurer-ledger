...
export function syntheticPack(overrides:{packRestricted?:boolean;entryRestricted?:boolean;packVersion?:string;revision?:number}={}):ContentPackDocument{
  ...
  return{
    schemaVersion:2,
    pack:{id:"pack:synthetic-moon",name:"Synthetic Moon Atlas",description:"Original test-only content",version,rulesEditions:["homebrew"],visibility:"private",licenseType:"original",exportRestricted:overrides.packRestricted??false,includeFullText:true,dependencies:[],optionalDependencies:[]},
